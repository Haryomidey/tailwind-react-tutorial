          ...
          <div>
            ...
            <div className='mt-8 grid lg:grid-cols-3 gap-10 '>
              ...
              <div className='card hover:shadow-lg'>
                <img src = {RecipeOne} className = "w-full h-32 sm:h-48 object-cover" />
                <div className='m-4'>
                  <span className='font-bold'>5 Bean Chilli Stew</span>
                  <span className='block text-gray-500 text-sm'>Recipe By Ayomide</span>
                </div>
                <div className='badge'>
              ...
              <div className='card hover:shadow-lg'>
                <img src = {RecipeTwo} className = "w-full h-32 sm:h-48 object-cover" />
                <div className='m-4'>
              ...
              <div className='card hover:shadow-lg'>
                <img src = {RecipeThree} className = "w-full h-32 sm:h-48 object-cover" />
                <div className='m-4'>
